...
#' The function for the \code{spict} model (Pedersen and Berg, 2016) is available in \link[MSEtool]{DLMextra}.
#'
...
#' \item \code{dep} Iniial depletion (B/B0) in the first year of the model. By default, 1.
