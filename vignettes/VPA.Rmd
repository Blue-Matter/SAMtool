---
title: "1d. Virtual population analysis (VPA)"
...
vignette: >
  %\VignetteIndexEntry{1d. Virtual population analysis (VPA)}
...
In any VPA model, estimates of F and N of the youngest age classes are highly uncertain. To stabilize estimates, random walk penalties can be applied to the  recruitment and vulnerabilty estimates in the most recent years:
$$ \begin{align}
