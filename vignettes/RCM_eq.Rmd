...
for mean weights, where $\eta_{y,f}$ is the standard deviation of mean size. With constant cofficient of variation (CV), $\eta_{y,f} = \bar{w}^{\textrm{obs}}_{y,f} CV^{\eta}_f$.
...
$$\Lambda_7 = \sum_f \lambda^{Y}_f \left(-\log(0.01) - \dfrac{[\log(Y^{\textrm{eq,obs}}_f) - \log(Y^{\textrm{eq,pred}}_f)]^2}{2 \times 0.01^2}\right),$$
