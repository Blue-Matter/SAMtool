...
The likelihood $L$ of the observed catch $I_t$, assuming a lognormal distribution, is
$$L^C = \sum_t \left(-\log(\sigma) - 0.5\left[\dfrac{\log(I_t) - \log(\hat{I}_t)}{\sigma}\right]^2\right),$$
