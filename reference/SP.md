...
# \donttest{
plot(res)
#> ℹ Writing markdown file: /tmp/RtmpANgsKg/report_SP.Rmd
#> ℹ Rendering markdown file: /tmp/RtmpANgsKg/report_SP.Rmd
#> ℹ See help(plot.Assessment) to adjust report and file directory.
#> ✔ Rendered file: /tmp/RtmpANgsKg/report_SP.html
...
# \donttest{
plot(res_SS)
#> ℹ Writing markdown file: /tmp/RtmpANgsKg/report_SP_SS.Rmd
#> ℹ Rendering markdown file: /tmp/RtmpANgsKg/report_SP_SS.Rmd
#> ℹ See help(plot.Assessment) to adjust report and file directory.
#> ✔ Rendered file: /tmp/RtmpANgsKg/report_SP_SS.html
# }
